...
class ApiClient extends GetConnect implements GetxService {
  ...
  ApiClient({required this.appBaseUrl, required this.sharedPreferences}) {
    try {
      ...
      _mainHeaders = {
        ...
        'app-id': '61151dc619e074b995f40062',
  ...
  void updateHeaderType(String type) {
    if (_mainHeaders != null) {
      _mainHeaders!.addAll({'type': type});
    }
  }
  ...
  Future<Response> postData(
    ...
    try {
      if (kDebugMode) {
        ...
        log('====> GetX Body: ${body is FormData ? body.files : body}', name: uri);
      }
